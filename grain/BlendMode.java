package com.h3music.videoeditor.grain;
...
public class BlendMode {
     ...
     */
    private static BufferedImage processing(BufferedImage bg, BufferedImage fg, double opacity, Mode mode) {
